...
module.exports = async (message, options) => {
  ...
  generalEmbed.fields[0].value = `Kartlar: ${yourcards.map((c) => `[\`${c.emoji} ${c.rank}\`](https://ertu.xyz)`).join(' ')}\nToplam:${isSoft ? ' Soft' : ''} ${yourcards.map((c) => c.value).reduce((a, b) => b + a)}`;
  generalEmbed.fields[1].value = `Kartlar: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://ertu.xyz) \` ? \`\nToplam: \` ? \``;
  ...
  if (yourvalue === 21 && dealervalue != 21) {
    if (options.resultEmbed === true) {
      ...
      winEmbed.fields.push({
        name: 'Senin elin',
        value: `Kartlar: [\`${yourcards[0].emoji} ${yourcards[0].rank}\`](https://ertu.xyz) [\`${yourcards[1].emoji} ${yourcards[1].rank}\`](https://ertu.xyz)\nToplam: ${yourvalue}`,
      });
      winEmbed.fields.push({
        name: 'Botun eli',
        value: `Kart: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://ertu.xyz) [\`${dealercards[1].emoji} ${dealercards[1].rank}\`](https://ertu.xyz)\nToplam: ${dealervalue}`,
      });
      commandType === 'message'
  ...
  //         loseEmbed.fields.push({ name: "Senin elin", value: `Kartlar: [\`${yourcards[0].emoji} ${yourcards[0].rank}\`](https://ertu.xyz) [\`${yourcards[1].emoji} ${yourcards[1].rank}\`](https://ertu.xyz)\nToplam: ${yourvalue}` })
  //         loseEmbed.fields.push({ name: "Botun eli", value: `Kartlar: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://ertu.xyz) [\`${dealercards[1].emoji} ${dealercards[1].rank}\`](https://ertu.xyz)\nToplam: ${dealervalue}` })
  ...
  // }
    ...
    if (options.resultEmbed === true) {
      ...
      tieEmbed.fields.push({
        name: 'Botun eli',
        value: `Kartlar: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://ertu.xyz) [\`${dealercards[1].emoji} ${dealercards[1].rank}\`](https://ertu.xyz)\nToplam: ${dealervalue}`,
      });
      commandType === 'message'
  ...
  if (options.resultEmbed === true) {
    ...
    finalEmbed.fields.push({
      name: `Senin elin`,
      value: `Kartlar: ${finalResult.ycard.map((c) => `[\`${c.emoji} ${c.rank}\`](https://ertu.xyz)`).join(' ')}\nToplam: ${finalResult.ycard.map((card) => card.value).reduce((a, b) => b + a)}`,
      inline: true,
    });
    if (finalResult.ycard2 != null) {
      finalEmbed.fields.push({
        name: `İkinci elin`,
        value: `Kartlar: ${finalResult.ycard2.map((c) => `[\`${c.emoji} ${c.rank}\`](https://ertu.xyz)`).join(' ')}\nToplam: ${finalResult.ycard2.map((card) => card.value).reduce((a, b) => b + a)}`,
        inline: true,
      });
    }
    finalEmbed.fields.push({
      name: `Botun eli`,
      value: `Kartlar: ${finalResult.dcard.map((c) => `[\`${c.emoji} ${c.rank}\`](https://ertu.xyz)`).join(' ')}\nToplam: ${finalResult.dcard.map((card) => card.value).reduce((a, b) => b + a)}`,
      inline: true,
    });
