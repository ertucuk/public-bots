module.exports = {
    ServerLogsChannel: {
        ...
        name: 'name-log',
        tagjoin: 'tag-log-join',
        tagleave: 'tag-log-leave',
        message: 'message-log',
        voice: 'voice-log',
        streamer: 'streamer-log',
        suspect: 'suspect-log',
        penalpoint: 'ceza-işlem',
        role: 'role-log',
        jail: 'jail-log',
        ads: 'ads-log',
        ban: 'ban-log',
        et: 'et-ceza-log',
        st: 'st-ceza-log',
        bannedtag: 'bannedtag-log',
        cmute: 'mute-log',
        vmute: 'vmute-log',
        warn: 'warn-log',
        join: 'join-log',
        staff: 'staff-log',
        unstaff: 'staff-leave-log',
        underworld: 'underworld-log',
        support: 'support-log',
        auth: 'auth-appeal-log',
        solver: 'solver-log'
    },
    ...
    channels: ['bot-commands', 'ship-chat', 'yetkili-komut', 'ceza-kaldırma', 'ship', 'ban-cezalı-komut'],
    coinChannels: ['coin-chat', 'coin'],
};